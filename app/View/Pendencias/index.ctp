	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($pendencia['Pessoa']['nome'], array('controller' => 'pessoas', 'action' => 'view', $pendencia['Pessoa']['id'])); ?>
                ...
                <td><?php echo h($pendencia['Pessoa']['endereco']); ?>&nbsp;<?php echo h($pendencia['Pessoa']['numero']); ?>&nbsp;<?php echo $this->Html->link($bairros[$pendencia['Pessoa']['bairro_id']], array('controller' => 'bairros', 'action' => 'view', $pendencia['Pessoa']['bairro_id'])); ?></td>
